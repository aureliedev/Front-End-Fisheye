    ...
    if (image) {
      mediaCard.innerHTML = `
            ...
            <div class="media-infos">
                ...
                <span class="likes">
                    <span class="likes-counter">${likes}</span> <i tabindex="0" title="Aimer l'image" role="button" aria-label="likes" class="fa-regular fa-heart"></i>
                </span>
            </div>
            `;
      return mediaCard;
    ...
    if (video) {
      mediaCard.innerHTML = `
            ...
            <div class="media-infos">
                <span class="title">${title}</span>
                <span class="likes">
                    <span role="button" class="likes-counter">${likes}</span> <i tabindex="0" title="Aimer la vidéo" role="button" aria-label="likes" class="fa-regular fa-heart"></i>
                </span>
            </div>
            `;
      return mediaCard;
